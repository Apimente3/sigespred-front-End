             ...
             <tr key={`trrowkey_${nro}`}>
                ...
                <td key={`tdrowkey_13${nro}`} className="acciones-3bot">
                    <div key={`divrowkey_${nro}`} className="btn-group pull-right">
                        ...
                        <Link  to={`/predio-gen-edit/${predio.id}/${predio.codigopredio}`}  className="btn btn-xs btn-default mright-5" type="button" data-toggle="tooltip" data-original-title={ "Editar Datos de Predio" }><i
